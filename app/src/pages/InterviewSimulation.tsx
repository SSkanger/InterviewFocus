          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              >
                ...
                <span className={`text-sm ${recording ? 'text-error' : 'text-muted-foreground'}`}>
                  {recording ? '录制中' : '录制已停止'}
                </span>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-success font-medium">进行中</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="w-full max-w-5xl mx-auto">
            <CardContent className="p-0">
              <div className="w-full aspect-video bg-muted rounded-lg flex items-center justify-center relative overflow-hidden">
                ...
                <div className="absolute top-4 right-4 bg-success/90 backdrop-blur-sm px-4 py-2 rounded-lg text-base font-medium text-success-foreground flex items-center gap-2">
                  <div className="w-2.5 h-2.5 rounded-full bg-success-foreground animate-pulse" />
                  录制中
                </div>
              </div>
            </CardContent>
        ...
        <div className="w-[320px] bg-card border-l border-border p-4 flex flex-col gap-4 shrink-0 overflow-y-auto">
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              <div className="flex items-center justify-between">
                <span className="text-muted-foreground">音频质量</span>
                <span className="text-success font-medium">优秀</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-muted-foreground">视频质量</span>
                <span className="text-success font-medium">高清</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-muted-foreground">延迟</span>
                <span className="text-success font-medium">32ms</span>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-3">
              <div className="space-y-2 text-sm">
                <div className="p-2 bg-muted rounded-lg">
                  <div className="text-xs text-muted-foreground mb-1">15:30</div>
                  <div>面试官：请介绍一下您的项目经验</div>
                </div>
                <div className="p-2 bg-primary/10 rounded-lg">
                  <div className="text-xs text-muted-foreground mb-1">15:28</div>
                  <div>应聘者：我参与过多个Python项目...</div>
                </div>
                <div className="p-2 bg-muted rounded-lg">
                  <div className="text-xs text-muted-foreground mb-1">15:25</div>
                  <div>面试官：您好，欢迎参加面试</div>
                </div>
              </div>
            </CardContent>
          </Card>
